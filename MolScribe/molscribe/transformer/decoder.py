...
class TransformerDecoderBase(DecoderBase):
    ...
    def from_opt(cls, opt, embeddings):
        ...
        return cls(
            ...
            if isinstance(opt.attention_dropout, list)
...
class TransformerDecoder(TransformerDecoderBase):
    ...
    def __init__(
        ...
        super(TransformerDecoder, self).__init__(d_model, copy_attn, alignment_layer)
    ...
    def forward(
        self, tgt_emb, memory_bank, src_pad_mask=None, tgt_pad_mask=None, step=None, **kwargs
    ):
