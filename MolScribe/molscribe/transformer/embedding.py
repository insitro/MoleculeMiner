...
class Embeddings(nn.Module):
    ...
    def __init__(
        ...
        self._validate_args(
            feat_merge, feat_vocab_sizes, feat_vec_exponent, feat_vec_size, feat_padding_idx
        )
    ...
    def _validate_args(
        self, feat_merge, feat_vocab_sizes, feat_vec_exponent, feat_vec_size, feat_padding_idx
    ):
        if feat_merge == "sum":
            ...
            if feat_vec_size != -1:
                warnings.warn(
                    "Merging with sum, but got non-default " "feat_vec_size. It will be unused."
                )
        elif feat_vec_size > 0:
