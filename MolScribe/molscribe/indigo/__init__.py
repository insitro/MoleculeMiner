...
class IndigoObject(object):
    ...
    def saveCml(self, filename):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSaveCmlToFile(self.id, filename.encode(ENCODE_ENCODING))
        )
    ...
    def optimize(self, options=""):
        ...
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoOptimize(self.id, options.encode(ENCODE_ENCODING))
        )
    ...
    def normalize(self, options=""):
        ...
        return bool(
            self.dispatcher._checkResult(
                Indigo._lib.indigoNormalize(self.id, options.encode(ENCODE_ENCODING))
            )
        )
    ...
    def getAcidPkaValue(self, atom, level, min_level):
        ...
        result = self.dispatcher._checkResultPtr(
            Indigo._lib.indigoGetAcidPkaValue(self.id, atom.id, level, min_level)
        )
        return result[0]
    ...
    def getBasicPkaValue(self, atom, level, min_level):
        self.dispatcher._setSessionId()
        result = self.dispatcher._checkResultPtr(
            Indigo._lib.indigoGetBasicPkaValue(self.id, atom.id, level, min_level)
        )
        return result[0]
    ...
    def iterateStereocenters(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateStereocenters(self.id)),
        )
    ...
    def iterateAlleneCenters(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateAlleneCenters(self.id)),
        )
    ...
    def iterateRGroupFragments(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateRGroupFragments(self.id)),
        )
    ...
    def iterateGenericSGroups(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateGenericSGroups(self.id)),
        )
    ...
    def iterateRepeatingUnits(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateRepeatingUnits(self.id)),
        )
    ...
    def iterateMultipleGroups(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateMultipleGroups(self.id)),
        )
    ...
    def getSuperatom(self, index):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoGetSuperatom(self.id, index)),
        )
    ...
    def getDataSGroup(self, index):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoGetDataSGroup(self.id, index)),
        )
    ...
    def getGenericSGroup(self, index):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoGetGenericSGroup(self.id, index)),
        )
    ...
    def getMultipleGroup(self, index):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoGetMultipleGroup(self.id, index)),
        )
    ...
    def getRepeatingUnit(self, index):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoGetRepeatingUnit(self.id, index)),
        )
    ...
    def setSGroupData(self, data):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupData(self.id, data.encode(ENCODE_ENCODING))
        )
    ...
    def setSGroupFieldName(self, name):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupFieldName(self.id, name.encode(ENCODE_ENCODING))
        )

    def setSGroupQueryCode(self, code):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupQueryCode(self.id, code.encode(ENCODE_ENCODING))
        )

    def setSGroupQueryOper(self, oper):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupQueryOper(self.id, oper.encode(ENCODE_ENCODING))
        )

    def setSGroupDisplay(self, option):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupDisplay(self.id, option.encode(ENCODE_ENCODING))
        )
    ...
    def setSGroupTag(self, tag):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupTag(self.id, tag.encode(ENCODE_ENCODING))
        )
    ...
    def setSGroupClass(self, sgclass):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupClass(self.id, sgclass.encode(ENCODE_ENCODING))
        )

    def setSGroupName(self, sgname):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoSetSGroupName(self.id, sgname.encode(ENCODE_ENCODING))
        )
    ...
    def removeTemplate(self, name):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoRemoveTemplate(self.id, name.encode(ENCODE_ENCODING))
        )

    def findTemplate(self, name):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoFindTemplate(self.id, name.encode(ENCODE_ENCODING))
        )
    ...
    def removeConstraints(self, type):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoRemoveConstraints(self.id, type.encode(ENCODE_ENCODING))
        )
    ...
    def resetAtom(self, symbol):
        self.dispatcher._setSessionId()
        self.dispatcher._checkResult(
            Indigo._lib.indigoResetAtom(self.id, symbol.encode(ENCODE_ENCODING))
        )
    ...
    def setBondOrder(self, order):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoSetBondOrder(self.id, order)),
        )
    ...
    def getProperty(self, prop):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResultString(
            Indigo._lib.indigoGetProperty(self.id, prop.encode(ENCODE_ENCODING))
        )
    ...
    def removeProperty(self, prop):
        self.dispatcher._setSessionId()
        return self.dispatcher._checkResult(
            Indigo._lib.indigoRemoveProperty(self.id, prop.encode(ENCODE_ENCODING))
        )
    ...
    def fingerprint(self, type):
        ...
        newobj = self.dispatcher._checkResult(
            Indigo._lib.indigoFingerprint(self.id, type.encode(ENCODE_ENCODING))
        )
        if newobj == 0:
            return None
        return self.dispatcher.IndigoObject(self.dispatcher, newobj, self)
    ...
    def iterateMatches(self, query):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateMatches(self.id, query.id)),
        )
    ...
    def decomposedMoleculeScaffold(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoDecomposedMoleculeScaffold(self.id)),
        )
    ...
    def iterateDecomposedMolecules(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateDecomposedMolecules(self.id)),
        )
    ...
    def decomposedMoleculeHighlighted(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoDecomposedMoleculeHighlighted(self.id)),
        )
    ...
    def decomposedMoleculeWithRGroups(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoDecomposedMoleculeWithRGroups(self.id)),
        )
    ...
    def decomposeMolecule(self, mol):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoDecomposeMolecule(self.id, mol.id)),
        )
    ...
    def iterateDecompositions(self):
        ...
        return self.dispatcher.IndigoObject(
            self.dispatcher,
            self.dispatcher._checkResult(Indigo._lib.indigoIterateDecompositions(self.id)),
        )
...
class Indigo(object):
    ...
    def setOption(self, option, value1, value2=None, value3=None):
        ...
        if (
            ...
            self._checkResult(
                Indigo._lib.indigoSetOptionInt(option.encode(ENCODE_ENCODING), value1)
            )
        elif type(value1).__name__ == "float" and value2 is None and value3 is None:
            self._checkResult(
                Indigo._lib.indigoSetOptionFloat(option.encode(ENCODE_ENCODING), value1)
            )
            ...
            if value1:
                value1_b = 1
            self._checkResult(
                Indigo._lib.indigoSetOptionBool(option.encode(ENCODE_ENCODING), value1_b)
            )
        elif (
            ...
            self._checkResult(
                Indigo._lib.indigoSetOptionXY(option.encode(ENCODE_ENCODING), value1, value2)
            )
        elif (
    ...
    def getOptionInt(self, option):
        ...
        value = c_int()
        self._checkResult(
            Indigo._lib.indigoGetOptionInt(option.encode(ENCODE_ENCODING), pointer(value))
        )
        return value.value
    ...
    def getOptionBool(self, option):
        ...
        value = c_int()
        self._checkResult(
            Indigo._lib.indigoGetOptionBool(option.encode(ENCODE_ENCODING), pointer(value))
        )
        if value.value == 1:
            return True
        return False
    ...
    def getOptionFloat(self, option):
        ...
        value = c_float()
        self._checkResult(
            Indigo._lib.indigoGetOptionFloat(option.encode(ENCODE_ENCODING), pointer(value))
        )
        return value.value
    ...
    def writeFile(self, filename):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(Indigo._lib.indigoWriteFile(filename.encode(ENCODE_ENCODING))),
        )
    ...
    def loadMoleculeFromBuffer(self, data):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(Indigo._lib.indigoLoadMoleculeFromBuffer(values, len(buf))),
        )
    ...
    def loadFingerprintFromBuffer(self, buffer):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(Indigo._lib.indigoLoadFingerprintFromBuffer(values, length)),
        )
    ...
    def exactMatch(self, item1, item2, flags=""):
        ...
        newobj = self._checkResult(
            Indigo._lib.indigoExactMatch(item1.id, item2.id, flags.encode(ENCODE_ENCODING))
        )
        if newobj == 0:
            return None
        else:
    ...
    def similarity(self, item1, item2, metrics=""):
        ...
        return self._checkResultFloat(
            Indigo._lib.indigoSimilarity(item1.id, item2.id, metrics.encode(ENCODE_ENCODING))
        )
    ...
    def substructureMatcher(self, target, mode=""):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(
                Indigo._lib.indigoSubstructureMatcher(target.id, mode.encode(ENCODE_ENCODING))
            ),
            target,
        )
    ...
    def rgroupComposition(self, molecule, options=""):
        ...
        self._setSessionId()
        newobj = self._checkResult(
            Indigo._lib.indigoRGroupComposition(molecule.id, options.encode(ENCODE_ENCODING))
        )
        if newobj == 0:
            return None
        else:
    ...
    def getFragmentedMolecule(self, elem, options=""):
        ...
        self._setSessionId()
        newobj = self._checkResult(
            Indigo._lib.indigoGetFragmentedMolecule(elem.id, options.encode(ENCODE_ENCODING))
        )
        if newobj == 0:
            return None
        else:
    ...
    def reactionProductEnumerate(self, replacedaction, monomers):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(
                Indigo._lib.indigoReactionProductEnumerate(replacedaction.id, monomers.id)
            ),
            replacedaction,
        )
    ...
    def loadString(self, string):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(Indigo._lib.indigoLoadString(string.encode(ENCODE_ENCODING))),
        )
    ...
    def iterateTautomers(self, molecule, params):
        ...
        return self.IndigoObject(
            self,
            self._checkResult(
                Indigo._lib.indigoIterateTautomers(molecule.id, params.encode(ENCODE_ENCODING))
            ),
            molecule,
        )
    ...
    def buildPkaModel(self, level, threshold, filename):
        self._setSessionId()
        return self._checkResult(
            Indigo._lib.indigoBuildPkaModel(level, threshold, filename.encode(ENCODE_ENCODING))
        )
