...
SUBSTITUTIONS: List[Substitution] = [
    ...
    Substitution(
        ["OBn"], "[OH0;D2][CH2;D2][cH0]1[cH][cH][cH][cH][cH]1", "[O]Cc1ccccc1", 0.7
    ),  # Benzyl
    ...
    Substitution(
        ["Fmoc"],
        "C(=O)O[CH2][CH1]1c([cH1][cH1][cH1][cH1]2)c2c3c1[cH1][cH1][cH1][cH1]3",
        "[C](=O)OCC1c(cccc2)c2c3c1cccc3",
        0.6,
    ),
    ...
    Substitution(
        ["PMB"], "[CH2;D2][cH0]1[cH1][cH1][cH0](O[CH3])[cH1][cH1]1", "[CH2]c1ccc(OC)cc1", 0.2
    ),
    ...
    Substitution(
        ["Ts"], "S(=O)(=O)c1[cH1][cH1][cH0]([CH3])[cH1][cH1]1", "[S](=O)(=O)c1ccc(C)cc1", 0.6
    ),  # Tos
    # Alkyl chains
